...
This config shows git metrics (lines added/removed), Kubernetes context, cloud provider, battery level, and local IP. Nerd Font icons for AWS, Azure, Terraform, Helm, and Rust.
