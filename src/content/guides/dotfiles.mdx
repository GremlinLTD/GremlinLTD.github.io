...
# --- Prompt character ---
[character]
success_symbol = ""                    # clean prompt on success
error_symbol = "[](bold red)"         # red cross on error
...
[aws]
symbol = ' '                           # nerd font AWS icon

[azure]
symbol = '󰠅 '                          # nerd font Azure icon

[terraform]
symbol = ' '                          # nerd font Terraform icon
format = '[$symbol$version - $workspace]($style) '

[helm]
symbol = ' '                          # nerd font Helm icon

# --- Languages ---
[rust]
symbol = '󱘗 '                          # nerd font Rust icon

[python]
symbol = ' '                           # nerd font Python icon

[golang]
symbol = ' '                           # nerd font Go icon
